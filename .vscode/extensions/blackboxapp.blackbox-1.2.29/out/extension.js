...
function activate(_) {
  ...
  <body style="margin:0px;padding:0px;overflow:hidden">
	...
	const generateRepo = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 1);
	//icon
	generateRepo.text= 'Generate Repo';
	generateRepo.tooltip = 'Generate a New Repo';
	generateRepo.command = 'blackbox.generateRepo';
	generateRepo.show();
